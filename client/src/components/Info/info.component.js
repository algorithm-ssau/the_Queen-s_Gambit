    ...
    componentDidMount(){
        switch(window.name){
            case "ElizabethHarmon":
                axios.get(`https://guarded-chamber-98334.herokuapp.com/info/ElizabethHarmon`)
                .then(response => {
                ...
                break;
            case "BennyWatts":
                axios.get(`https://guarded-chamber-98334.herokuapp.com/info/BennyWatts`)
                .then(response => {
                    console.log(response);
                    this.setState({info:response.data});
                 })
                ...
                break;
            case "HarryBeltik":
                axios.get(`https://guarded-chamber-98334.herokuapp.com/info/HarryBeltik`)
                .then(response => {
                    console.log(response);
                    this.setState({info:response.data});
                 })
                ...
                break;
            case "AlmaWhittle":
                axios.get(`https://guarded-chamber-98334.herokuapp.com/info/AlmaWhittle`)
                .then(response => {
                    console.log(response);
                    this.setState({info:response.data});
                 })
                ...
                break;
            case "mrScheibel":
                axios.get(`https://guarded-chamber-98334.herokuapp.com/info/mrScheibel`)
                .then(response => {
                    console.log(response);
                    this.setState({info:response.data});
                 })
                ...
                break;
            case  "Jolene":
                axios.get(`https://guarded-chamber-98334.herokuapp.com/info/Jolene`)
                .then(response => {
                    console.log(response);
                    this.setState({info:response.data});
                 })
                ...
                break;
            case "HelenDirdorrf":
                axios.get(`https://guarded-chamber-98334.herokuapp.com/info/HelenDirdorrf`)
                .then(response => {
                    console.log(response);
                    this.setState({info:response.data});
                 })
            ...
            case "AllstonWheatley":
                axios.get(`https://guarded-chamber-98334.herokuapp.com/info/AllstonWheatley`)
                .then(response => {
                    console.log(response);
                    this.setState({info:response.data});
                 })
                ...
                break;
            case "Towns":
                axios.get(`https://guarded-chamber-98334.herokuapp.com/info/Towns`)
                .then(response => {
                    console.log(response);
                    this.setState({info:response.data});
                 })
                ...
                break;
            case "VasilyBorgov":
                axios.get(`https://guarded-chamber-98334.herokuapp.com/info/VasilyBorgov`)
                .then(response => {
                    console.log(response);
                    this.setState({info:response.data});
                 })
                ...
                break;
            case "AliceHarmon":
                axios.get(`https://guarded-chamber-98334.herokuapp.com/info/AliceHarmon`)
                .then(response => {
                    console.log(response);
                    this.setState({info:response.data});
                 })
                ...
                break;
            case "AnnettePacker":
                axios.get(`https://guarded-chamber-98334.herokuapp.com/info/AnnettePacker`)
                .then(response => {
                    console.log(response);
                    this.setState({info:response.data});
                 })
            ...
            case "AnyaTaylorJoy":
                axios.get(`https://guarded-chamber-98334.herokuapp.com/info/AnyaTaylorJoy`)
                .then(response => {
                    console.log(response);
                    this.setState({info:response.data});
                 })
            ...
            case "ThomasBrodieSangster":
                axios.get(`https://guarded-chamber-98334.herokuapp.com/info/ThomasBrodieSangster`)
                .then(response => {
                    console.log(response);
                    this.setState({info:response.data});
                 })
                ...
                break;
            case "HarryMelling":
                axios.get(`https://guarded-chamber-98334.herokuapp.com/info/HarryMelling`)
                .then(response => {
                    console.log(response);
                    this.setState({info:response.data});
                 })
                ...
                break;
            case "MarielleHeller":
                axios.get(`https://guarded-chamber-98334.herokuapp.com/info/MarielleHeller`)
                .then(response => {
                    console.log(response);
                    this.setState({info:response.data});
                 })
                ...
                break;
            case "WilliamCamp":
                axios.get(`https://guarded-chamber-98334.herokuapp.com/info/WilliamCamp`)
                .then(response => {
                    console.log(response);
                    this.setState({info:response.data});
                 })
                ...
                break;
            case  "MosesIngram":
                axios.get(`https://guarded-chamber-98334.herokuapp.com/info/MosesIngram`)
                .then(response => {
                    console.log(response);
                    this.setState({info:response.data});
                 })
            ...
            case "ChristianeSeidel":
                axios.get(`https://guarded-chamber-98334.herokuapp.com/info/ChristianeSeidel`)
                .then(response => {
                    console.log(response);
                    this.setState({info:response.data});
                 })
                ...
                break;
            case "PatrickKennedy":
                axios.get(`https://guarded-chamber-98334.herokuapp.com/info/PatrickKennedy`)
                .then(response => {
                    console.log(response);
                    this.setState({info:response.data});
                 })
            ...
            case "JacobFortuneLloyd":
                axios.get(`https://guarded-chamber-98334.herokuapp.com/info/JacobFortuneLloyd`)
                .then(response => {
                    console.log(response);
                    this.setState({info:response.data});
                 })
            ...
            case "MarcinDorociński":
                axios.get(`https://guarded-chamber-98334.herokuapp.com/info/MarcinDorociński`)
                .then(response => {
                    console.log(response);
                    this.setState({info:response.data});
                 })
                ...
                break;
            case "ChloePirri":
                axios.get(`https://guarded-chamber-98334.herokuapp.com/info/ChloePirri`)
                .then(response => {
                    console.log(response);
                    this.setState({info:response.data});
                 })
                ...
                break;
            case "EloiseWebb":
                axios.get(`https://guarded-chamber-98334.herokuapp.com/info/EloiseWebb`)
                .then(response => {
                    console.log(response);
                    this.setState({info:response.data});
                 })
